#ifndef PREPROCESSOR_ROTATE_NMS_UTILS_H
#define PREPROCESSOR_ROTATE_NMS_UTILS_H
...
#define HOST_DEVICE_INLINE HOST_DEVICE
...
HOST_DEVICE_INLINE void get_rotated_vertices(
  ...
  T cosTheta2 = (T)cos(box.a) * 0.5f;
  T sinTheta2 = (T)sin(box.a) * 0.5f;
...
single_box_iou_rotated(T const* const box1_raw, T const* const box2_raw) {
  ...
  auto center_shift_x = (box1_raw[2] + box2_raw[2]) / 2.0;
  auto center_shift_y = (box1_raw[3] + box2_raw[3]) / 2.0;
  box1.x_ctr = box1_raw[2]; // - center_shift_x;
  box1.y_ctr = box1_raw[3]; // - center_shift_y;
  box1.w = box1_raw[0];
  box1.h = box1_raw[1];
  box1.a = box1_raw[4];
  box2.x_ctr = box2_raw[2]; // - center_shift_x;
  box2.y_ctr = box2_raw[3]; // - center_shift_y;
  box2.w = box2_raw[0];
  box2.h = box2_raw[1];
  box2.a = box2_raw[4];
